...
In this section, we are showing you how to utilize the openshift-pipeline as the CI to fully automate the tasks from building EE to running the Job template using the EE which was built as part of the same CI process. 
...
.. Verify new execution environment ee-automated-pipeline has been added.
